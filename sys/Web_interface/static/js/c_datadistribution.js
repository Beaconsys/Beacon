$("#submit").click(function() {
    ...
    $.ajax({
        url : "/draw_cdatadistribution",
        type : 'post',
        data : $('#form_cdatadistribution').serialize(),
        dataType : 'json',
        success : function(data) {
            ...
            //$("#wavg").html(wavg);
            //$("#wsum").html(wsum);
            $('#image_read_datadistribution').attr('src', '/image/'+jobid+"_cread_datadistribution.png");
            $('#image_write_datadistribution').attr('src', '/image/'+jobid+"_cwrite_datadistribution.png");
        },
        error : function() {
