...
def create_csv(data, time_s, time_e):
    ...
    time_p = str(data[0].split(' ')[7])[0:10] + ' ' +  str(data[0].split(' ')[7])[11:-5]
    line_p = (datetime.datetime.strptime(time_p, "%Y-%m-%d %H:%M:%S") - datetime.datetime.strptime(time_s, "%Y-%m-%d %H:%M:%S")).seconds
    ...
    for line in range(1, len(data)):
        ...
        time_c = str(data[line].split(' ')[7][0:10] + ' ' + str(data[line].split(' ')[7])[11:-5])
        line_c = (datetime.datetime.strptime(time_c, "%Y-%m-%d %H:%M:%S") - datetime.datetime.strptime(time_s, "%Y-%m-%d %H:%M:%S")).seconds
        ...
        if host_p == host_c:
            time_delta = (datetime.datetime.strptime(time_c, "%Y-%m-%d %H:%M:%S") - datetime.datetime.strptime(time_p, "%Y-%m-%d %H:%M:%S")).seconds
